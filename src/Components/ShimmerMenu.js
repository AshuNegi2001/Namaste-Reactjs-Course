...
const ShimmerMenuCard = () => {
  return (
    <>
      <div className="mx-auto xl:w-6/12 lg:w-7/12 md:w-9/12 sm:w-11/12 w-full p-3">
...
const ShimmerMenu = () => {
  return (
    <>
      <div className="">
        <div className=" w-full h-48 shadow-xl flex justify-center">
          <div className=" animate-pulse w-1/5 h-40 bg-slate-300 flex justify-center my-3 rounded-lg"></div>
          <div className="flex flex-col lg:w-1/4 md:3/4 w-2/4 ml-12 my-auto">
